...
app.config['SQLALCHEMY_DATABASE_URL'] = os.environ.get("DB_URI", "sqlite:///posts.db")
...
def show_post(post_id):
    ...
    return render_template("post.html", post=requested_post, curerent_user=current_user, form=comment_form)
